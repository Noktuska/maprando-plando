...
pub fn rev_key_conv(code: egui::Key) -> Option<Key> {
    ...
    Some(match code {
        ...
        EKey::OpenBracket => Key::LBracket,
        EKey::CloseBracket => Key::RBracket,
        EKey::Num0 => Key::Num0,
        EKey::Num1 => Key::Num1,
        EKey::Num2 => Key::Num2,
        EKey::Num3 => Key::Num3,
        ...
        EKey::F12 => Key::F12,
        EKey::Plus => Key::Add,
        EKey::Equals => Key::Equal,
        EKey::Minus => Key::Hyphen,
        EKey::Slash => Key::Slash,
        EKey::Backtick => Key::Tilde,
        _ => return None,
    })
}

pub fn key_conv(code: Key) -> Option<egui::Key> {
    use egui::Key as EKey;
    Some(match code {
        ...
        Key::Num0 | Key::Numpad0 => EKey::Num0,
        Key::Num1 | Key::Numpad1 => EKey::Num1,
        Key::Num2 | Key::Numpad2 => EKey::Num2,
        Key::Num3 | Key::Numpad3 => EKey::Num3,
        Key::Num4 | Key::Numpad4 => EKey::Num4,
        Key::Num5 | Key::Numpad5 => EKey::Num5,
        Key::Num6 | Key::Numpad6 => EKey::Num6,
        Key::Num7 | Key::Numpad7 => EKey::Num7,
        Key::Num8 | Key::Numpad8 => EKey::Num8,
        Key::Num9 | Key::Numpad9 => EKey::Num9,
        Key::A => EKey::A,
        Key::B => EKey::B,
        Key::C => EKey::C,
        Key::D => EKey::D,
