...
use maprando::{preset::PresetData, settings::{parse_randomizer_settings, InitialMapRevealSettings, MapRevealLevel, NotableSetting, RandomizerSettings, TechSetting}};
...
pub fn try_upgrade_settings(
    ...
    *settings
        .get_mut("version")
        .context("missing version field")? = 119.into();
